...
export interface GameInfo {
    ...
    label: string;
    tooltip: string;
    aiModes?: Array<{ label: string }>;
    linked?: Array<{ label: string; key: GameType }>;
}
...
export const GAMES: GameInfo[] = [
    ...
    { key: 'stance', label: '招式对战', tooltip: '在7×7场地上博弈，从7种招式中选5张组成套牌，双方同时出招，移动并攻击，命中扣1血，5血先见底者负', aiModes: [{ label: 'vs AI' }], linked: [{ label: 'Boss战', key: 'boss-blast' }] },
];
